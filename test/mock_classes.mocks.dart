...
// in news_app/test/mock_classes.dart.
...
import 'package:news_app/core/error/failure.dart' as _i7;
import 'package:news_app/domain/entities/news.dart' as _i8;
import 'package:news_app/domain/repositories/auth_repository.dart' as _i4;
import 'package:news_app/domain/repositories/news_repository.dart' as _i5;
import 'package:news_app/domain/usecases/auth_usecases.dart' as _i10;
import 'package:news_app/domain/usecases/get_news_list.dart' as _i11;
...
class _FakeNewsRepository_8 extends _i1.SmartFake
    implements _i5.NewsRepository {
  _FakeNewsRepository_8(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
///
/// See the documentation for Mockito's code generation for more information.
class MockGetNewsList extends _i1.Mock implements _i11.GetNewsList {
  MockGetNewsList() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i5.NewsRepository get repository => (super.noSuchMethod(
        Invocation.getter(#repository),
        returnValue: _FakeNewsRepository_8(
          this,
          Invocation.getter(#repository),
        ),
      ) as _i5.NewsRepository);

  @override
  _i6.Future<_i2.Either<_i7.Failure, List<_i8.News>>> call(
